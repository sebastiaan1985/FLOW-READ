...
| Toegankelijkheid | Dyslexie Leeslab, donkere modus (automatisch, licht of donker), reduce-motion bij alle animaties, tekst die meeschaalt met de lettergrootte van het apparaat, labels op alle bediening, zachte trillingen als bevestiging (alleen in de app). Een axe-scan (WCAG 2.1 AA) vindt niets op de hoofdschermen, in licht en donker |
