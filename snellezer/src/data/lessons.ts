...
export const LESSONS: Lesson[] = [
  ...
  // Week 2 — Blikveld
  {day:8,week:2,title:'Woorden in groepjes',what:'Chunking betekent dat je woorden in groepjes leest in plaats van één voor één.',why:'Zinnen bestaan uit delen die bij elkaar horen. Wie in zinsdelen leest, leest vloeiender en ziet sneller wat bij elkaar hoort.',how:'Je ziet steeds een kort zinsdeel, meestal twee woorden. Kijk naar het midden van de groep en neem hem in één keer op.',hint:'Kijk naar het midden van de groep.',exerciseId:'chunks',params:{chunk:2,tempoFactor:1},support:'groups',measure:'begrip'},
  {day:9,week:2,title:'Grotere groepjes',what:'Vandaag vergroot je de groep naar drie woorden.',why:'Veel zinsdelen bestaan uit drie woorden: de lezer, het boek, een mooie dag. Die herken je als één beeld.',how:'De zinsdelen worden langer, meestal drie woorden. Houd je blik op het gekleurde woord in het midden; de rest vang je vanzelf op.',hint:'Het middelste woord is je anker.',exerciseId:'chunks',params:{chunk:3,tempoFactor:1},support:'fixation',measure:'begrip'},
