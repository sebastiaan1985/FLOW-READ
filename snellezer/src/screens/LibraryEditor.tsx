...
import {BackHeader, Button, Card, Icon, IconButton, Pill, Row, Screen, SectionHeading, T} from '../components/UI';
...
export function LibraryEditor({actions,onBack=()=>actions.onTab('today')}:{actions:AppActions;onBack?:()=>void}) {
  ...
  return <Screen style={{maxWidth:900}}>
    ...
    <Row style={{gap:20}}><Illustration name="eigen-tekst" size={wide?112:85}/><View style={{flex:1,gap:8}}><T variant="title" style={{fontSize:wide?38:29}}>Jouw tekst. Meer eruit halen.</T><T color={ui.muted}>Train met een artikel, studietekst of je eigen verhaal. Alles wat je bewaart blijft op dit apparaat.</T></View></Row>
